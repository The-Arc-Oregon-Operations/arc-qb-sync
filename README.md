...
| `[course_offers_online]` | Offer delivery Online (109) | `"1"` or `"0"` |
| `[course_offers_inperson]` | Offer delivery In-Person (110) | `"1"` or `"0"` |
...
See [`CLAUDE.md`](CLAUDE.md) for working conventions: Cowork/Code split, versioning, session notes, orchestration prompt format, end-of-session discipline, and Windows + OneDrive recovery recipes.

Per-version Code session handoff prompts are at `CLAUDE_CODE_PROMPT_v*.md`.
